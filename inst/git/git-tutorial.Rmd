...
<br/>
<p>
<img src="giphy-frustrated.gif" style="width: 450px; margin-bottom:50px;">
</p>
</center>
</div>
...
- The name of the Github repo doesn't have to be the same as that of the local repo, but it should 
...
- The function in the `add.R` file contained a typo
